...
import { Text, Container, Flex, Link, HStack } from '@chakra-ui/react'
  ...
  return (
    <Container maxW="container.lg">
      ...
      <HStack gap="20px" mb="20px">
        <Link as={RouterLink} to={`${dashboardPath}`}>
          总览
        </Link>
        <Link as={RouterLink} to={`${dashboardPath}/analysis`}>
          分析
        </Link>
        <Link as={RouterLink} to={`${dashboardPath}/setting`}>
          设置
        </Link>
      </HStack>
      <Outlet />
