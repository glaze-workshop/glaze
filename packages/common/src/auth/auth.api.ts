 ...
 * @returns 用户数据和token
 */
export const login = (loginDTO: AuthLoginDTO) => axios.post(AUTH_LOGIN_PATH, loginDTO)
 ...
 */
export const register = (registerDTO: AuthRegisterDTO) => axios.post(AUTH_REGISTER_PATH, registerDTO)
